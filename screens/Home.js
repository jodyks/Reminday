    ...
    return (
        ...
        <ScrollView style={styles.container}>
            ...
            { todayTodos.length > 0  
              ...
              : <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', marginBottom: 20}}>
                  ...
                  <Text style={{fontSize: 13, color: '#737373', fontWeight: '500'}}>No task for today, enjoy your day.</Text>
                </View>
            }
            ...
            { tomorrowTodos.length > 0  
              ...
              : <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', marginBottom: 20}}>
                  <Image
                    ...
                    style={{width: 150, height: 150, marginBottom: 20, resizeMode: 'contain'}}
                  />
                  <Text style={{fontSize: 13, color: '#000', fontWeight: 'bold'}}>GOOD!</Text>
                  <Text style={{fontSize: 13, color: '#737373', fontWeight: '500'}}>Nothing on the list for tomorrow..</Text>
                </View>
            }
        ...
        : <View style={styles.container}>
            ...
            <View style={{justifyContent: 'center', alignItems: 'center', flex: 1}}>
                ...
                />
                <Text style={{fontSize: 13, color: '#000', fontWeight: 'bold'}}>YIPPE!</Text>
                <Text style={{fontSize: 13, color: '#737373', fontWeight: '500'}}>Nothing is on your task right now.</Text> 
            </View>
